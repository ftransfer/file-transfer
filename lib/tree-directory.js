...
function readChildren(FS, PATH, path, options, onEachFile, onEachDirectory) {
  if (options && !options.depth) options.depth = 1;
  else options = { ...options, depth: 1 };
  ...
  if (options && !options.opts.viewFiles && tree.children)
...
export { readDirTree, readChildren };
